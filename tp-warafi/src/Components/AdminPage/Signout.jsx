...
export default function Signout({ isOpen, onClose,onSignout }) {
 ...
 return (
     <div className={`absolute w-full h-full flex items-center justify-center ${isOpen ? 'flex' : 'hidden'}`}>
        ...
        <div className=' absolute z-20 flex flex-col items-center justify-around h-1/2 xl:w-1/3 border-[5px] border-solid border-[#771079] bg-white rounded-[20px]'>      
            <div className=' '>
