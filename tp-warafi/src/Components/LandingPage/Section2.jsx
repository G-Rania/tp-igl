...
import img from '../../Images/LandingPage/Section2.svg'

const Section2 = () => {
    return(
        <div className="bg-[#E9E9E9] flex h-full">
            <div className='flex flex-col justify-center ml-0 mr-auto '>
            ...
            <div className=' flex flex-col justify-end w-96 p-4 mr-24 ml-0 translate-x-10 lg:-translate-x-20 items-end '>
                <h1 className=' font1 text-[#771079]  ml-10 xs:text-2xl lg:text-3xl xl:text-4xl items-end'>
                Discover the latest scientific articles</h1>
