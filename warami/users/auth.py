    ...
    if request.method == 'POST':
        ...
        try:
            ...
            # Set the access token in a cookie
                response = JsonResponse({'access_token': str(access_token),'user_id':user.pk},status =200)
...
def forgot_password(request):
    if request.method == 'POST':
        ...
        try:
            ...
            reset_link = f"http://localhost:8000/users/auth/reset_password/?reset_token={reset_token}"  # Replace with your actual reset link logic
