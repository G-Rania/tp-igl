...
const Adminbarre = ({onSignout ,which}) =>{
    const [whichPage, setWhichPage ] = useState(which);
  ...
  useEffect(() => {
    // Check the value of whichPage after the state update is complete
    console.log("Current whichPage:", whichPage);
  }, [whichPage]);
